...
# computer scientists call linear programming. Although we don't go into this
# topic in detail in this course, we include the code anyway:
...
# We note that these players all have above average BB and HR rates while the
# same is not true for singles.
